    ...
    func handle(
        ...
        context.deferQueryRequestToNetwork { networkResponse, error in
            ...
            if let networkResponse = networkResponse {
                // Server classified the SMS
                finalResponse.action = networkResponse.action
                finalResponse.subAction = networkResponse.subAction
            } else {
                // Server unreachable — allow the message through
